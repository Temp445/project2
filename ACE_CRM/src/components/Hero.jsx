...
export default function Hero() {
  return (
    <div className=" mx-auto xxxl:container">
      ...
      >
        <h1 className="flex w-full px-4  lg:px-0  lg:w-[500px] xl:w-[620px] lg:h-[50.25%] justify-start items-center font-['Inter'] text-[24px] xl:text-[36px] font-bold lg:font-extrabold leading-[1.4] lg:leading-[60px] text-white tracking-[-1.5px] relative lg:absolute py-6 lg:py-0 lg:top-0  lg:left-10 xxl:left-24 xxxl:left-52 2xl:left-36 xl:left-10 text-left z-[16]">
          Supercharge Your Business with a Centralized, All-in-One CRM Solution
        </h1>

        <div className=" hidden lg:block w-full h-[300px] md:h-[200px] lg:w-[550px] lg:h-[600px] xl:w-[620px] xl:h-[700px]   xl:mt-0  bg-cover bg-no-repeat relative lg:absolute  lg:left-[550px] xxl:left-[800px] xxxl:left-[1000px] xl:left-[700px]  2xl:left-[800px] z-[3]">
          <video
        ...
        <div className="flex w-full px-4 md:px-0  sm:justify-center lg:justify-start relative lg:absolute lg:bottom-[95px] lg:left-[40px] xl:left-[40px] xxxl:left-52  2xl:left-[150px] xxl:left-24 gap-4 z-[19] py-6 lg:py-0">
